...
export function SchemaVisualizerPage() {
    ...
    // Use URL params directly as the selected values (they're always current)
    // Fall back to store values if URL params are empty
    ...
    // Sync to shared store when selection changes
    useEffect(() => {
